...
৩. **ভূমিকা অনুচ্ছেদ** (সম্পূর্ণ bold) — ইনভার্টেড পিরামিড লিড: পুরো নিবন্ধ পড়ে সবচেয়ে গুরুত্বপূর্ণ তথ্যটি প্রথম বাক্যে বলুন — ৩-৪টি পূর্ণ বাক্য
...
⚠️ ইনভার্টেড পিরামিড নিয়ম (অবশ্যই মানতে হবে):
- ✅ সঠিক: প্রথম বাক্যেই মূল সংবাদ — "চাঙ্গি বিমানবন্দর টানা ১৪তম বারের মতো বিশ্বের সেরা বিমানবন্দরের পুরস্কার পেয়েছে।"
- ❌ ভুল: সূত্র নিবন্ধের শুরুর দৃশ্যকল্প বা বর্ণনামূলক ভূমিকা হুবহু অনুসরণ করা
- ⚠️ কঠোর নিষেধ: ইনপুট নিবন্ধের কোনো তথ্য, সংখ্যা, তারিখ, নাম, উদ্ধৃতি পরিবর্তন বা বাদ দেওয়া যাবে না — শুধু উপস্থাপনার ক্রম নির্ধারণ করুন
...
REMOVE: info boxes, sidebar tip boxes, "How to experience / How to get there / Getting there / Travel tips / Practical information" boxes, bulleted logistics lists that are auxiliary to the article, "More like this" link lists.
...
INVERTED PYRAMID RULE — applies to both intro and body (mandatory):
- INTRO: Lead with the single most newsworthy fact in the very first sentence. Do NOT open with the source article's scene-setting, narrative hook, or atmospheric opener.
  ✅ Correct: "Changi Airport has won the Skytrax best airport award for the 14th consecutive year, beating Hamad and Incheon."
  ❌ Wrong: "After an 18-hour flight, bleary-eyed passengers arrive to find..." (source's atmospheric opener — not news)
- BODY: Within each paragraph, put the most important sentence first. Across all paragraphs, arrange by descending news value — do NOT mirror the source article's paragraph sequence.
- ⚠️ STRICT: Never change, omit, or invent any fact, number, statistic, date, name, or quote. Only the ORDER of presentation changes — all information must be preserved exactly.
...
class ContentEnhancer:
    ...
    def combined_translate_enhance(self, raw_english_text: str, article_info: dict,
        ...
        user_prompt = (
            f"Today's date: {today} — use this to determine tense (past for events before this date, future for events after).\n\n"
