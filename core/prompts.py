...
# ============================================================================
# ARCHIVED FORMATS (Not currently used - kept for reference)
# ============================================================================
# These formats were part of the original system but are not used in the
# newspaper-focused workflow. They are commented out to reduce code bloat
# but kept for potential future use.

# NEWSPAPER_SYSTEM_PROMPT - General newspaper format (replaced by Hard/Soft News)
NEWSPAPER_SYSTEM_PROMPT_ARCHIVED = """আপনি একজন অভিজ্ঞ বাংলাদেশী সাংবাদিক যিনি প্রথম আলো, দৈনিক স্টার বা বণিক বার্তার মতো নামকরা পত্রিকায় লেখেন।
...
# BLOG_SYSTEM_PROMPT - Personal blog style format (archived)
BLOG_SYSTEM_PROMPT_ARCHIVED = """আপনি একজন জনপ্রিয় বাংলাদেশী ভ্রমণ ব্লগার যিনি 'ঘুরে আসি', 'ভ্রমণবিলাস' এর মতো ব্লগে লেখেন।
...
# FACEBOOK_SYSTEM_PROMPT - Social media post format (archived)
FACEBOOK_SYSTEM_PROMPT_ARCHIVED = """আপনি একজন সোশ্যাল মিডিয়া এক্সপার্ট যিনি বাংলাদেশী দর্শকদের জন্য Facebook পোস্ট তৈরি করেন।
...
# INSTAGRAM_SYSTEM_PROMPT - Instagram caption format (archived)
INSTAGRAM_SYSTEM_PROMPT_ARCHIVED = """আপনি একজন Instagram কন্টেন্ট ক্রিয়েটর যিনি বাংলাদেশী ট্রাভেল ইনফ্লুয়েন্সার।
...
# ============================================================================
# ACTIVE FORMATS (Currently in use)
# ============================================================================
# These are the formats used in the newspaper-focused workflow
...
FORMAT_CONFIG = {
    # ========================================================================
    # ARCHIVED FORMATS - Commented out (not used in newspaper-focused workflow)
    # ========================================================================
    # 'newspaper': {
    #     'name': 'সংবাদপত্র',
    #     'icon': '📰',
    #     'system_prompt': NEWSPAPER_SYSTEM_PROMPT_ARCHIVED,
    #     'temperature': 0.5,
    #     'max_tokens': 1500,
    ...
    #     'name': 'ব্লগ পোস্ট',
    #     'icon': '📝',
    #     'system_prompt': BLOG_SYSTEM_PROMPT_ARCHIVED,
    #     'temperature': 0.7,
    #     'max_tokens': 2000,
    ...
    #     'name': 'ফেসবুক পোস্ট',
    #     'icon': '📱',
    #     'system_prompt': FACEBOOK_SYSTEM_PROMPT_ARCHIVED,
    #     'temperature': 0.8,
    #     'max_tokens': 500,
    ...
    #     'icon': '📸',
    #     'system_prompt': INSTAGRAM_SYSTEM_PROMPT_ARCHIVED,
    #     'temperature': 0.8,
    #     'max_tokens': 400,
